...
public class NotesActivity extends FragmentActivity implements
	...
	public void getAllNotes(){
		...
		ArrayAdapter<Note> noteAdapter=new ArrayAdapter<Note>(getApplicationContext(),android.R.layout.simple_list_item_1 ,listNotes);
		ListView lstViewNotes = (ListView)findViewById(R.id.lstSavedNotes);
	...
	public static class DummySectionFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_notes_dummy,
					container, false);
